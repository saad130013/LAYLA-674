...
import { FileDown, Filter, PieChart, Printer, Eye } from 'lucide-react';
                                    ...
                                    {filteredReports.map(report => {
                                        ...
                                        <tr key={report.id} className="bg-white dark:bg-gray-800 border-b dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700">
                                            ...
                                            <td className="px-6 py-4">
                                                <span className={`px-2 py-1 rounded-full text-xs font-bold ${report.status === 'Reviewed' ? 'bg-green-100 text-green-800' : report.status === 'Needs Corrective Action' ? 'bg-red-100 text-red-800' : 'bg-gray-100 text-gray-800'}`}>
